...
| Repositories maintained | 69 public · 40 private |
| Core languages | Dart · Python · TypeScript · JavaScript |
| Domain focus | Logistics · AgriTech · AI-native SaaS · HealthTech |
| Availability | Open to opportunities |
| Base | Lusaka, Zambia · Remote-friendly |
...
- **Scaling** — NDU production rollout at nduproject.com; staging → production pipeline hardening
- **Optimizing** — offline LLM inference (Qwen2-1.5B) for low-connectivity agricultural regions
- **Exploring** — agent orchestration patterns for autonomous task execution systems
